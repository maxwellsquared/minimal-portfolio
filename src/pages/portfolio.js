...
const Portfolio = () => {
    return (
        <Layout pageTitle="Portfolio">
            <section>
                <h3><a href="https://simplenpc.vercel.app">SimpleNPC</a></h3>
                <p><i>SimpleNPC lets you generate Dungeons and Dragons NPCs on the spot--for those times when your party just HAS to know everything about those background characters you didn't give a second thought.</i></p>
                <StaticImage width="600" alt="Text interface with a randomly generated Dungeons and Dragons character" src="https://github.com/maxwellsquared/minimal-portfolio/blob/main/img/npc1.jpg?raw=true"/>
                <p><i>NPCs get randomly generated names, genders, occupations, secrets/rumours, possessions and stat blocks (generated by rolling 4d6 and dropping the lowest die, just like you would IRL!).</i></p>
                <StaticImage width="600" alt="Text interface with a randomly generated Dungeons and Dragons character" src="https://github.com/maxwellsquared/minimal-portfolio/blob/main/img/npc2.jpg?raw=true"/>
